...
## License
IDFCNN is released under the Eclipse Public License - v 2.0, Eclipse Distribution License - v 1.0 prior to Apache 2.0 license. Please see the LICENSE.md file for more information.
